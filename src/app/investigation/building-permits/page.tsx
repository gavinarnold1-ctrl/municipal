...
export default function BuildingPermitsPage() {
  return (
    ...
    >
      <P>
        Building Department fee revenue fell from <span className="text-paper">$14.5M</span>{" "}
        in FY24 to <span className="text-paper">$5.8M</span> in FY25. The proposed FY26
